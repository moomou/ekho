...
exports.bootstrap = function(req, res, next) {
    ...
    var jsFile =  bootstrapTemplate({
        ...
        RENDERED   : '<div id="ekho-container"> <form action="#" method="post" id="search"> <div> <label for="name">Text Input:</label> <div id="info-field"> <input type="text" name="name" id="info-input" class="attention" value="" tabindex="1" placeholder="Search..."/> </div> <div class="effect-copy attention"></div> <div id="button-field"> <input type="submit" id="button-input" class="attention" value="Submit" /> </div> </div> </form> </div>',
